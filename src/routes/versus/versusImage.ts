...
childRoutes.get('/me', Only(Child), async (req, res) => {
    try {
        const { parent, ...me1 } = req.user as Child;

        // const myStory = me1.stories[0];
        // console.log('myStory', myStory);
        // let myStoryPages = null;

        // if (me1.stories[0]) myStoryPages = storyParse(me1.stories[0].story);

        // let myIllustration = null;

        // if (me1.illustrations[0])
        //     myIllustration = illustrationParse(me1.illustrations[0].illustration);
        // console.log('myStoryPages', illustrationParse(myIllustration));
        const me = {
            ...me1,
            stories: [
                {
                    ...me1.stories[0],
                    story: me1.stories[0] && storyParse(me1.stories[0].story),
                },
            ],
            illustrations: [
                {
                    ...
                    illustration:
                        me1.illustrations[0] &&
                        illustrationParse(me1.illustrations[0].illustration),
                },
            ],
        };
        res.json({ me });
