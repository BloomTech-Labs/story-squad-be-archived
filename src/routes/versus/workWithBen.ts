...
// battlesRoutes.get('/versusadasd', Only(Child), async (req, res) => {
//     try {
...
//         const homeTeam = await returnMatch(id, cohort.week);
...
//         let player1 = {
//             studentId: match.team1_child1_id,
//             ...player1,

//         }
//         let player2 = match.team1_child2_id;
//         let player3 = match.team2_child1_id;
//         let player4 = match.team2_child2_id;
