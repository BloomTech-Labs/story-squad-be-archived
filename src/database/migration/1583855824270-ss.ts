...
export class ss1583855824270 implements MigrationInterface {
    name = 'ss1583855824270'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "submissions" DROP COLUMN "transcribed_text"`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" ADD "transcribedTextPage1" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" ADD "transcribedTextPage2" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" ADD "transcribedTextPage3" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" ADD "transcribedTextPage4" character varying`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" ADD "transcribedTextPage5" character varying`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "submissions" DROP COLUMN "transcribedTextPage5"`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" DROP COLUMN "transcribedTextPage4"`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" DROP COLUMN "transcribedTextPage3"`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" DROP COLUMN "transcribedTextPage2"`, undefined);
        await queryRunner.query(`ALTER TABLE "submissions" DROP COLUMN "transcribedTextPage1"`, undefined);
